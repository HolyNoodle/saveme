...
public class DrawOnTopPermissionModule extends ReactContextBaseJavaModule {
    ...
    public DrawOnTopPermissionModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public String getName() {
        return "DrawOnTopPermissionModule";
    }
