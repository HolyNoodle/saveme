...
// Thrid party
import { Animated, Easing, Modal as ReactModal, ModalBaseProps } from "react-native";
...
const Modal: React.FunctionComponent<ModalProps> = ({ children, actions, visible, ...props }) => {
